...
<div class ="table">
    <table class="table">
    <tr>
        <td rowspan=2><font size=6>Arqueo de Caja: </font><br><font size=5><?php echo $hoy; ?> </font></td>
        <td > <font size=5>Usuario: </font> <font size=4><?php $us=obtenerUsuario($_SESSION["idUsuario"]);
                                          foreach ($us as $u) {
