...
guardarProducto($_POST["nombre"], $_POST["categoria"], $_POST["precioinicial"],$_POST["preciofinal"],$_POST["descuento"],$_POST["unidadcantidad"],$_POST["caducidad"],$_POST["detalles"],$active);
